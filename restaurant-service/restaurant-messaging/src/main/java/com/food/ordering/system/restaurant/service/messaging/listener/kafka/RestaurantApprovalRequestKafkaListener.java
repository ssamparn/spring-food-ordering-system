    ...
    public void receive(@Header(KafkaHeaders.RECEIVED_KEY) List<String> keys,
        ...
        messages.forEach(restaurantApprovalRequestAvroModel -> {
            try {
                ...
                RestaurantApprovalRequest restaurantApprovalRequest = restaurantMessagingDataMapper.restaurantApprovalRequestAvroModelToRestaurantApproval(restaurantApprovalRequestAvroModel);
                ...
                if (sqlException != null && sqlException.getSQLState() != null && PSQLState.UNIQUE_VIOLATION.getState().equals(sqlException.getSQLState())) {
                    ...
                    log.error("Caught unique constraint exception with sql state: {} in RestaurantApprovalRequestKafkaListener for order id: {}",
                ...
                log.error("No restaurant found for restaurant id: {}, and order id: {}", restaurantApprovalRequestAvroModel.getRestaurantId(),
