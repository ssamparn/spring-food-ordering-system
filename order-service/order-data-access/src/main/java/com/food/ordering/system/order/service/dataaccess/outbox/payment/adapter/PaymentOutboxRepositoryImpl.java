...
public class PaymentOutboxRepositoryImpl implements PaymentOutboxRepository {
    ...
    public OrderPaymentOutboxMessage save(OrderPaymentOutboxMessage orderPaymentOutboxMessage) {
        PaymentOutboxEntity paymentOutboxEntity = paymentOutboxDataAccessMapper.orderPaymentOutboxMessageToOutboxEntity(orderPaymentOutboxMessage);
        PaymentOutboxEntity savedPaymentOutboxEntity = paymentOutboxJpaRepository.save(paymentOutboxEntity);

        return paymentOutboxDataAccessMapper.paymentOutboxEntityToOrderPaymentOutboxMessage(savedPaymentOutboxEntity);
    }
