...
public class Order extends AggregateRoot<OrderId> {
    ...
    public void initializeCancellation(List<String> failureMessages) {
        if (orderStatus != OrderStatus.PAID) {
    ...
    private void validateOrderItemsPrice() {
        Money orderItemsTotal = orderItems.stream()
                .map(orderItem -> {
                    validateIndividualOrderItemPrice(orderItem);
    ...
    private void validateIndividualOrderItemPrice(OrderItem orderItem) {
