...
public class OrderOutboxRepositoryImpl implements OrderOutboxRepository {
    ...
    public OrderOutboxMessage save(OrderOutboxMessage orderPaymentOutboxMessage) {
        ...
        OrderOutboxEntity orderOutboxEntity = orderOutboxDataAccessMapper.orderOutboxMessageToOutboxEntity(orderPaymentOutboxMessage);
        OrderOutboxEntity savedOutboxEntity = orderOutboxJpaRepository.save(orderOutboxEntity);

        return orderOutboxDataAccessMapper.orderOutboxEntityToOrderOutboxMessage(savedOutboxEntity);
    }
